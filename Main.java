...
public class TicTacToe {
	  ...
	  public static int bot_help(char[][]gameboard, char now){
	    ...
	    int count = 1;
	    boolean first = true;
	    return bot(gameb,now,count,first);
	  }


	  public static int bot(char[][]gameboard, char now, int count, boolean first){
	      ...
	      for(int j=0;j<3;j++){
	        ...
	        if(istaken(gameboard,counter));
		        ...
		        if(first) {
		        	if(now=='O'){
			            insert(gameboard,counter,"player2");
			            score = bot(gameboard,'X',count,false);
			            if(score > max){
			              max = score;
			              count = counter;
			            } 
			            ...
			            insert(gameboard,counter,"player1");
			            score = bot(gameboard,'O',count,false);
			            if(score > max){
			              max = score;
			              count = counter;
			            }
	        		...
	        		if(now=='O') {
	        			insert(gameboard,counter,"player2");
	        			a += bot(gameboard,'X',count,false);
	        		}
	        		else {
	        			insert(gameboard,counter,"player1");
	        			a += bot(gameboard,'O',count,false);
	        		}
	        	}
	  ...
	  public static int score(char[][]g){
	    if(check(g,'O').equals("win")) return 20;
